            ...
            <table class="table-fixed border-collapse border border-slate-500">
                <thead>
                    <tr class="">
                        ...
                        <th class="border-2 border-orange-100 bg-orange-100 w-32 h-10 text-white cursor-default">Tanggal</th>
                        <th class="border-2 border-orange-100 bg-orange-100 w-32 h-10 text-white cursor-default">NIS</th>
                        ...
                        <th class="border-2 border-orange-100 bg-orange-100 w-32 h-10 text-white cursor-default">Jurusan</th>
                        <th class="border-2 border-orange-100 bg-orange-100 w-32 h-10 text-white cursor-default">Kasus</th>
                        <th class="border-2 border-orange-100 bg-orange-100 w-40 h-10 text-white cursor-default">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="border-2 border-gray-50 bg-gray-50 py-2 text-center">Merokok</td>
                        ...
                        <div class="py-6 px-6 lg:px-8">
                            ...
                            <form class="space-y-6 my-5" action="#">
                                <div class="mx-4 mb-5">
                                    ...
                                    <label for="sasaran" class="text-xs text-gray-400">NIS :</label>
                                    ...
                                    <label for="layanan" class="text-xs text-gray-400">Nama Siswa :</label>
                                    ...
                                    <label for="hasil" class="text-xs text-gray-400">Kelas :</label>
                                    ...
                                    <label for="hasil" class="text-xs text-gray-400">Jurusan :</label>
                                    <input type="text" name="hasil" id="jurusan" class="bg-white border border-gray-300 text-gray-500 text-sm rounded-xl focus:ring-tosca-300 focus:border-tosca-300 block w-80 py-2.5 px-4 my-3 font-light drop-shadow-sm hover:bg-gray-50 duration-200" required=""> </input>
                                    <label for="hasil" class="text-xs text-gray-400">Kasus:</label>
                                    <input type="text" name="hasil" id="jurusan" class="bg-white border border-gray-300 text-gray-500 text-sm rounded-xl focus:ring-tosca-300 focus:border-tosca-300 block w-80 py-2.5 px-4 my-3 font-light drop-shadow-sm hover:bg-gray-50 duration-200" required=""> </input>
                                </div>
